  ...
  <g id="Anterior_View_Muscles" data-name="Anterior View Muscles">
    ...
    <g id="Adductors_Abductors" data-name="Adductors/Abductors">
      <g>
        ...
        <path fill={fill('abductor')} opacity={getMuscleOpacity('adductor')} d="M129.17,249.1c-7.52,21.61-8.99,54.91-10.46,82.75,2.56-17.71,8.9-39.19,15.47-54.95,3.88-20.3,6.52-13.7-5.02-27.8Z"/>
      </g>
      <g>
    ...
    <g id="Pecs" transform="translate(129, 73)">
      <path fill={fill('chest_mid')} opacity={getMuscleOpacity('chest_mid')} transform="translate(0, 2)" d="M51.8068 54.8791c-13.67 11.33-38.8 7.6-48.94-7.8-7.72-12.34 2-11.9474 7.4746-13.1 9.5-2 19-3.0841 27.5-4.5 8.5-1.4158 10-2.9119 16.5-2.3627 6.5.5491 7.7354 18.5827-2.5346 27.7627ZM51.8068 54.8791c-13.67 11.33-38.8 7.6-48.94-7.8-7.72-12.34 2-11.9474 7.4746-13.1 9.5-2 19-3.0841 27.5-4.5 8.5-1.4158 10-2.9119 16.5-2.3627 6.5.5491 7.7354 18.5827-2.5346 27.7627Z"/>
      <path fill={fill('chest_mid')} opacity={getMuscleOpacity('chest_mid')} transform="translate(0, 2)" d="M69.5181 54.503c-10.2056-9.0561-8.978-26.8465-2.5187-27.3882 6.4592-.5417 7.9498.9341 16.3965 2.3309 8.4467 1.3967 17.8871 2.4663 27.3271 4.4393 5.441 1.137 15.1.7497 7.428 12.9232-10.076 15.1923-35.0486 18.872-48.6329 7.6948Z"/>
    ...
    <g id="Front_Side_Delts" data-name="Front/Side Delts">
      <path fill={fill('front_delt')} opacity={getMuscleOpacity('front_delt')} d="M116.72,97.36c10.08-11.47,26.29-26.45,42.73-31.09,5.85-1.94-12.81-5.05-13.26-4.88-8.48-.76-14.78,1.34-21.08,5.32-16.65,9.89-24.72,30.09-27.93,50.04-1.25,9.1,18.48-19.19,19.54-19.39Z"/>
      <path fill={fill('front_delt')} opacity={getMuscleOpacity('front_delt')} d="M262.99,97.44c1.04.21,20.87,28.52,19.48,19.32-3.22-19.95-11.28-40.14-27.93-50.04-6.3-3.99-12.6-6.09-21.08-5.32-.72-.16-19.02,2.97-13.26,4.88,16.47,4.65,32.7,19.66,42.79,31.16Z"/>
    </g>
    <g id="Biceps">
